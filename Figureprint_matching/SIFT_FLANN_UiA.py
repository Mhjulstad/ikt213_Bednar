...
def process_dataset(dataset_path, results_folder):
    threshold = 15  # Adjust this based on tests
    ...
    match_count, match_img = match_fingerprints("UiA_image/pair_image/UiA_1.jpg", "UiA_image/pair_image/UiA_2.png")
    print(f"Good matches: {match_count}")
    cv2.imwrite("SIFT_FLANN_UiA.png", match_img)
...
# Example usage
dataset_path = r"C:\Users\mhjul\Semester 5\ikt213g26h\Figureprint_matching\UiA_image"
results_folder = r"C:\Users\mhjul\Semester 5\ikt213g26h\Figureprint_matching\sift_flann_UiA"
