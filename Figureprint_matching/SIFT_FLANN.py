...
def match_fingerprints(img1_path, img2_path):
    ...
    sift = cv2.SIFT_create(nfeatures=1130)
...
def process_dataset(dataset_path, results_folder):
    threshold = 13  # Adjust this based on tests
...
# Example usage
dataset_path = r"C:\Users\mhjul\Semester 5\ikt213g26h\Figureprint_matching\FingerPrint\data_check"
results_folder = r"C:\Users\mhjul\Semester 5\ikt213g26h\Figureprint_matching\FingerPrint\sift_flann_"
